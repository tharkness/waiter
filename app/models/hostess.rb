class Hostess < ActiveRecord::Base
  ...
  def increase_two_seat_wait
    restaraunt.increment(:two_seat_wait, 5)
  end

  def increase_four_seat_wait
    restaraunt.increment(:four_seat_wait, 5)
  end

  def increase_large_table_wait
    restaraunt.increment(:large_table_wait, 5)
  end

  def decrease_two_seat_wait
    restaraunt.decrement(:two_seat_wait, 5)
  end

  def decrease_four_seat_wait
    restaraunt.decrement(:four_seat_wait, 5)
  end

  def decrease_large_table_wait
    restaraunt.decrement(:large_table_wait, 5)
  end
